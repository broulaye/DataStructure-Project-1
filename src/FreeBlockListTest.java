...
public class FreeBlockListTest extends TestCase {
    ...
    public void testFreeSpace() {
        ...
        assertEquals(13, list.get(1).getX());
        assertEquals(17, list.get(1).getY());
        assertEquals(4, list.size);
        // (0,3) -> (8,25)
        list.freeUpSpace(21, 5);
        assertEquals(21, list.get(1).getX());
        assertEquals(25, list.get(1).getY());
        // (0,3) -> (8,25) -> (27,31)
        list.freeUpSpace(27, 5);
        assertEquals(21, list.get(2).getX());
        ...
        assertEquals(5, list.get(2).getX());
        assertEquals(5, list.get(2).getY());
