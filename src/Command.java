/**
 * This class represent a command. each command contain an operation value that store
 * what operation the command is executing. each command, beside the insert command, also
 * has a type that specify if the command is being run on a song, artist, or block. finaly
 * each command also as a value that present the argument of the command
...
public class Command {
	...
	/**
	 * Default constructor that every fields to
	 * defaults values
	 */
	public Command() {
		op = null;
	 ...
	 * @param value value the values is going to be set to
	 */
