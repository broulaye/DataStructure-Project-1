	...
	public String printTable() {
		...
		for (Handle handle : valueArray) {
			if (handle != null && !handle.isTombStone()) {
				builder.append("|").append(handle2String(handle)).
				append("| ").append(pos).append("\n");
			}
			pos++;
		}
		builder.append("total ").append(type.toLowerCase()).
		append("s: ").append(numbElements).append("\n");
...
>>>>>>> 3e80e7ed5133b6316c8a7a640039dcbaca18ad55
}